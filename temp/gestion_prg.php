                ...
                <div class="formulaire" style="min-height: 25em; padding: 0;">
                    ...
                    <div ng-if="boisson.screen" class="screen">
                        ...
                        <div class="L_left" style="margin-top: 0.4em" ng-if="boisson.contenu!=null" ng-repeat="contenant in boisson.contenu.contenants">
                            ...
                            <div class="bouton" ng-click="maj_contenu_contenant_consigne(boisson.contenu,contenant); contenant.modif_consigne=false;" ng-if="contenant.modif_consigne" style="margin-left: 1em; font-size: 0.9em; padding: 1px;">
                            Enregistrer
                            </div>
                            <div class="bouton" ng-click="contenant.suppr_vers=true; contenant.select_suppr_vers=true;" ng-if="!contenant.suppr_vers" style="margin-left: 1em; font-size: 0.9em; padding: 1px;">
                            Supprimer vers
                            </div>
                            
                            <div class="item_formulaire" style="margin-left: 4em; font-size: 0.9em;" ng-if="contenant.suppr_vers">Supprimer vers :</div>
                            <div class="item_formulaire" style="margin-left: 4em; font-size: 0.9em;" ng-if="contenant.select_suppr_vers">Nom du nouveau contenant :</div>                           
                            <div ng-if="contenant.select_suppr_vers">
                                <input type="text" placeholder="Taper le nom du contenant" ng-model="boisson.search3" style="font-size: 0.9em; width: 15em; margin-left: 0.5em;" autocomplete="off" ng-click="boisson.auto_c3=true; message.statu='none';"/>
                                
                                <div class="auto_c" ng-if="boisson.auto_c3 && boisson.search3!=null" style="margin-left: 0.9em;">
                                    <div class="auto_c_value" ng-repeat="item in contenants_list | filter : boisson.search3" ng-click="contenant.new_contenant=item; boisson.auto_c3=false; boisson.search3=null; contenant.select_suppr_vers=false;">{{item.nom}}</div>
                                </div>
                            </div>
                            ...
                            <div class="item_formulaire" style="margin-left: 4em; font-size: 0.9em;" ng-if="contenant.new_contenant">{{contenant.new_contenant.nom}}</div>
                            <div class="bouton" ng-click="contenant.suppr_vers=false; suppr_vers_contenant(contenant.id,contenant.new_contenant.id,boisson.contenu); contenant.new_contenant=null;" ng-if="contenant.new_contenant" style="margin-left: 1em; font-size: 0.9em; padding: 1px;">
                            Ok
                            </div>
                    ...
                    <div ng-if="constante.screen" class="screen">
                        <div class="L_left" ng-repeat="constante in constantes_list" style="margin-top: 0.8em;">
                            ...
                            <div class="item_formulaire" ng-if="!constante.modif && $index!=2">{{prix(constante.valeur)}}</div>
                            <div class="item_formulaire" ng-if="!constante.modif && $index==2">{{constante.valeur}}</div>
                            <input type="number" ng-model="constante.valeur" ng-if="constante.modif ">
                           
                            <div class="bouton" ng-click="constante.modif=true; message.statu='none';" ng-if="!constante.modif">Modifier</div>
