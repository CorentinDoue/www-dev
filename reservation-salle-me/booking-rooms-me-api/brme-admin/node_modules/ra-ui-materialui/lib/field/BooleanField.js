...
var BooleanField = function BooleanField(_ref) {
    ...
    if ((0, _get2.default)(record, source) === false) {
        return _react2.default.createElement(_Clear2.default, (0, _extends3.default)({ className: className }, (0, _sanitizeRestProps2.default)(rest)));
    }

    if ((0, _get2.default)(record, source) === true) {
        return _react2.default.createElement(_Done2.default, (0, _extends3.default)({ className: className }, (0, _sanitizeRestProps2.default)(rest)));
    }
