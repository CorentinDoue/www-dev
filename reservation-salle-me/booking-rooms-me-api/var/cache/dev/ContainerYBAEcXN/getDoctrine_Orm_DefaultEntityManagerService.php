...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\UserCustomRepository' => function () {
    return ($this->privates['App\Repository\UserCustomRepository'] ?? $this->load('getUserCustomRepositoryService.php'));
}))));
