...
// Returns the private 'App\Repository\UserCustomRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserCustomRepository.php';

return $this->privates['App\Repository\UserCustomRepository'] = new \App\Repository\UserCustomRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
