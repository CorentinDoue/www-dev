...
--
-- Client :  localhost
-- Généré le :  Lun 25 Septembre 2017 à 19:26
...
CREATE TABLE IF NOT EXISTS `contenu_mob` (
  `ID` int(11) NOT NULL,
...
INSERT INTO `contenu_mob` (`ID`, `Description`, `titre`, `contenu_mob`) VALUES
...
INSERT INTO `parcours` (`ID`, `nom`, `prenom`, `promo`, `domaines`, `date_debut`, `date_fin`, `ECTS`, `tuteur`, `type_mobilite`, `type_convention`, `rapport`, `bulletin`, `remarques`) VALUES
(1, 'Chassagne', 'Valentin', 2015, 'Résistance des mollets', '2018-02-01', '2018-06-25', 25, 'Helmut Klocker', 'S10', '', 'Alexandre Mellios - U Oslo.pdf', 'Alexandre Mellios - U Oslo.pdf', ''),
(2, 'Hamm', 'Thibaut', 2015, 'Énergie interne du mollet', '2017-05-30', '2017-09-02', 0, 'Christophe Desrayaud', 'Stage 2A', 'saintéstage ', '', 'Alexandre Mellios - U Oslo.pdf', 'Comme Thibaut n''a pas troué de stage, l''école lui a trouvé celui ci.');
