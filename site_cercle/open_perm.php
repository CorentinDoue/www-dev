...
<html id="page">
    ...
    <body ng-app="open_perm_app"  ng-controller="mainController">
            ...
            <div class="layer_window">
                ...
                <div class="C_centre">
                    ...
                    <div class="item_inventaire" ng-if="new_boisson.contenu!=null" ng-class="color_boisson(new_boisson.contenu)">
                        ...
                        <div class="L_center"><span class="titre_item">{{new_boisson.contenu.nom}}</span></div> 
                        <div class="L_left">
                    ...
                    <div class="centreur"><div class="bouton" ng-click="add_boisson(new_boisson.contenu)">Valider</div></div>
                </div>
            </div>           
        </div>
        <div class="layer2" ng-if="layer3">
            <div class="layer_window"> 
                ...
                <div class="C_centre">
                    ...
                    <div class="item_inventaire" ng-if="!isin_consommables(new_consommable.consommable_name)"> </div>
                    <div class="item_inventaire autre" ng-if="isin_consommables(new_consommable.consommable_name)">
                        <div class="L">
                            <div class="L_left"> 
        ...
        echo "<script type=\"text/javascript\">var droit_cercle='".$_SESSION['droit']."'</script>";
