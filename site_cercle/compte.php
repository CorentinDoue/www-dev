    		...
    		<div class="centreur">                
                <div class="C_centre">
                    <div class="L_tableau" >
                        ...
                        <?php
                            if ($_GET["id"]==0) {
                                echo "<div class=\"head_tableau clickable\" ng-click=\"compte.order('easy_search')\" style=\"width: 125%;\">Client</div>";
                            }
                        ?>
                        <div class="head_tableau clickable" ng-click="compte.order('quantite')" style="width: 50%;">Quantité</div>
                        <div class="head_tableau clickable" ng-click="compte.order('produit')">Produit</div>
                    ...
                    <div class="L_tableau" ng-class="color($index)" ng-repeat="operation in operations | filter : x | orderBy : compte.ordervalue">
