                ...
                <div class="formulaire" style="min-height: 25em; padding: 0;">
                    ...
                    <div ng-if="constante.screen" class="screen">
                        <div class="L_left" ng-repeat="constante in constantes_list" style="margin-top: 0.8em;">
                            ...
                            <div class="bouton" ng-click="constante.modif=true; message.statu='none';" ng-if="!constante.modif && $index!=3">Modifier</div>
                            <div class="bouton" ng-click="message.statu='none'; constante.valeur=(constante.valeur+1)%2; valid_constante(constante);" ng-if="$index==3">Modifier</div>
