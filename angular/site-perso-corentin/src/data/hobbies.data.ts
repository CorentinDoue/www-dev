...
export const HOBBIES: Hobby[] = [
  new Hobby(
    'Running',
    'running',
    'I run on average twice a week. I started in 2012 because it is healthy but I still practising because I like. ' +
    ...
    [
      new Image(
        'La Sainté Lyon',
        'La Sainté Lyon is a mythical race which at Saint-Etienne and leads to Lyon. ' +
  ...
  new Hobby(
    ...
    [
      new Image(
        ...
        'It the best way to train because it develops strength and stamina.',
        'neoliet.jpg',
        true
      ),
      new Image(
        'My climbing room at Auxerre',
        'I started climbing in this room in my town (Auxerre). It is a wall 12 meters height with lot of routes. ' +
  ...
  new Hobby(
    ...
    [
      ...
      new Image(
        ...
        'This the after movie of the week.',
        'https://www.youtube.com/embed/aohSbZc53NM',
        true
      ),
      new Image(
        'Mont Blanc at Praz-sur-Arly',
        'The apartment of my father is in the little ski station of Praz-sur-Arly. I go there one a year. ' +
  ...
  new Hobby(
    ...
    [
      ...
      new Image(
        'Culinary Hike',
        'One of the best event of the Associflard is the culinary hike. It is a hike of around 6 km in regional park of "Le Pilat". ' +
      ...
      new Image(
        'Floor Meal',
        'In the student house of the engineering school, we were group by floor. ' +
  ...
  new Hobby(
    'Crafting',
    'crafting',
    'I have always been a manual guy. I like do the thing by my self. So when I need something I craft it. ' +
    ...
    [
      new Image(
        'Circle bar',
        'As vice-president of the student office participated to the organization of parties. ' +
