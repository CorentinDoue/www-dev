...
/***/ "./src/app/skills/skills-home/active-skill.pipe.ts":
/*!*********************************************************!*\
  !*** ./src/app/skills/skills-home/active-skill.pipe.ts ***!
  \*********************************************************/
/*! exports provided: ActiveSkillPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActiveSkillPipe", function() { return ActiveSkillPipe; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ActiveSkillPipe = /** @class */ (function () {
    function ActiveSkillPipe() {
    }
    ActiveSkillPipe.prototype.transform = function (selectedType) {
        switch (selectedType) {
            case ('languages'): {
                return 0;
            }
    ...
    ActiveSkillPipe = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"])({ name: 'activeSkill' })
    ], ActiveSkillPipe);
    return ActiveSkillPipe;
}());
...
module.exports = "spc-skills-list .row {\n  margin: 0;\n  margin-bottom: 20px; }\n\nspc-skills-list h3 {\n  text-align: center; }\n\nspc-skills-list h4 {\n  font-size: 1.5em;\n  text-decoration: underline;\n  white-space: nowrap; }\n\nspc-skills-list p {\n  font-size: 1.3em;\n  text-align: justify; }\n\nspc-skills-list .mat-button {\n  font-size: 1.1em; }\n\nspc-skills-list .skill-name {\n  display: flex;\n  justify-content: center;\n  align-items: center; }\n\n@media (max-width: 992px) {\n  spc-skills-list .skill-name {\n    margin-bottom: -20px; } }\n"
...
/* harmony import */ var _skills_home_active_skill_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./skills-home/active-skill.pipe */ "./src/app/skills/skills-home/active-skill.pipe.ts");
/* harmony import */ var _web_skills_list_web_skills_list_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./web-skills-list/web-skills-list.component */ "./src/app/skills/web-skills-list/web-skills-list.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SkillsModule = /** @class */ (function () {
    ...
    SkillsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_skills_home_skills_home_component__WEBPACK_IMPORTED_MODULE_2__["SkillsHomeComponent"], _progress_bar_progress_bar_component__WEBPACK_IMPORTED_MODULE_4__["ProgressBarComponent"], _skills_list_skills_list_component__WEBPACK_IMPORTED_MODULE_5__["SkillsListComponent"], _web_skills_list_web_skills_list_component__WEBPACK_IMPORTED_MODULE_7__["WebSkillsListComponent"], _skills_home_active_skill_pipe__WEBPACK_IMPORTED_MODULE_6__["ActiveSkillPipe"]]
        })
    ], SkillsModule);
    return SkillsModule;
}());
...
var WebSkillsListComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], WebSkillsListComponent.prototype, "selectedIndex", void 0);
...
var SKILLS = {
    'language': [
        ...
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('C', 4, 'General-purpose, imperative computer programming language. It is a low-level language ' +
            'which should be compile to machine instructions.', 'I used it a lot in pratical works in courses of C, Computer sciences and Big Data.', [], 'c.png'),
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Python', 4, 'Interpreted high-level programming language for general-purpose programming.', 'I used it a lot in pratical works in courses during my preparatory classes. ' +
            'I worked also with it during a three month internship to implement neural network.', ['stage_2a'], 'python.png'),
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Shell', 3.5, 'Script designed to be run by the shell command-line interpreter of Unix devices.', 'I used it a lot in pratical works in courses of Computer sciences and Big Data. ' +
            'I worked also with it during a three month internship to preprocess and move the datas.', ['stage_2a'], 'shell.png'),
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('PHP', 4.5, 'Server-side scripting language designed for Web development, but also used as a' +
            ...
            'it to develop the backend of other websites. I used it also when I learned the framework Symfony in courses.', ['minesterstellar', 'mobilite', 'cercle'], 'php.png'),
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('SQL', 4, 'Domain-specific language used in programming and designed for managing data held in ' +
            ...
            'I used MySQL a lot to manage the data of my three first websites.', ['minesterstellar', 'mobilite', 'cercle'], 'sql.png'),
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Java', 5, 'General-purpose computer-programming language that is concurrent, class-based and object-oriented.', 'I learned it in Java courses and had lot of pratical works with it. I used also as backend' +
            ' language for a Computer sciences project.', ['project_majeure_info'], 'java.png'),
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('JavaScript', 4.5, 'High-level, interpreted programming language used in web development.', 'I learned it by myself with MOOCs to animate my first web site. I used also as frontend language ' +
            'for all the websites I did after.', ['minesterstellar', 'mobilite', 'cercle', 'project_majeure_info', 'spc'], 'js.png'),
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('TypeScript', 2, 'Open-source programming language which is a strict syntactical superset of JavaScript.', 'I learned it by using Angular.', ['spc'], 'ts.png'),
    ...
    'web': {
        'Front-end': [
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Html', 4.5, 'Standard markup language for creating web pages and web applications.', 'I learned it by myself with MOOCs to create my first web site. I used also for all the websites I did after.', ['minesterstellar', 'mobilite', 'cercle', 'project_majeure_info', 'spc'], 'html.png'),
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('CSS', 4, 'Style sheet language used for describing the presentation of a document written in a markup language like HTML.', 'I learned it by myself with MOOCs to create my first web site. I used also for all the websites I did after.', ['minesterstellar', 'mobilite', 'cercle', 'project_majeure_info', 'spc'], 'css.png'),
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('SCSS or Sass', 4, 'Preprocessor scripting language that is interpreted or compiled into CSS.', 'I learned it by myself on internet to properly use Bootstrap 4 and Material.', ['spc'], 'scss.png'),
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Bootstrap', 4, 'Free and open-source front-end framework for designing websites and web applications.', 'I learned it by myself on internet to make quick responsive web sites.', ['project_majeure_info', 'spc'], 'bootstrap.png'),
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Material', 3, 'Design system – backed by open-source code – that helps teams build digital experiences.', 'I learned it by myself on internet to build this web site.', ['spc'], 'material.png'),
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('AngularJS', 4, 'JavaScript-based open-source front-end web application framework.', 'I learned it by myself with MOOCs to use it as frontend for my second and third websites.', ['mobilite', 'cercle'], 'angular.png'),
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Vue.js', 3, 'Open-source JavaScript framework for building user interfaces.', 'I learned it in Computer sciences courses.', ['project_majeure_info'], 'vuejs.png'),
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Angular', 3, 'TypeScript-based open-source front-end web application framework.', 'I learned it by myself on internet to build this web site.', ['spc'], 'angular.png'),
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Android', 2.5, 'Mobile operating system designed primarily for touchscreen mobile devices such as smartphones and tablets.', 'I learned it in Computer sciences courses.', ['project_majeure_info'], 'android.png')
        ],
        'Back-end': [
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Spring', 3, 'Java framework to develop web applications.', 'I learned it in Computer sciences courses.', ['project_majeure_info'], 'spring.png'),
        ...
        'Managers': [
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Gradle', 4, 'Open-source build automation system mostly used with java.', 'I learned it in Computer sciences courses with Spring and Android.', ['project_majeure_info'], 'gradle.png'),
            ...
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('NPM', 3.5, 'Package manager for the JavaScript programming language.', 'I learned it by using Angular.', ['spc'], 'npm.png')
        ]
    },
    'ia': [
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Tensorflow', 4, 'open-source software library for dataflow programming. It is used for machine learning applications such as neural networks.', 'I learned it during my three month internship à Erasmus MC.', ['stage_2a'], 'tensorflow.png'),
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Keras', 4.5, 'Open source neural network library written in Python.', 'I used it with Tensorflow backend during my three month internship à Erasmus MC.', ['stage_2a'], 'keras.png')
    ],
    'graphical': [
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Photoshop', 2, 'Raster graphics editor.', 'I used it for personnal stuffs or to preprocess images I want display on my websites.', [], 'photoshop.png'),
        ...
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('Blender', 3, 'Professional, free and open-source 3D computer graphics software.', 'I used it to make some 3D annimations for an association film.', ['film_campagne'], 'blender.png')
    ],
    'other': [
